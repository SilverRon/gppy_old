#============================================================
#	AT2019ein/SN2018ein/NGC5353/NGC5350 FIELD
...
obs			= raw_input('OBS\t: ')
if obs == 'LOAO':
	path_qso	= '/data3/IMSNG/IMSNGgalaxies/NGC5350/LOAO'
	path_gundam	= '/mnt/window/Users/User/Downloads/data/Project/AT2019ein/LOAO'
if obs == 'DOAO':
	path_qso	= '/data3/IMSNG/IMSNGgalaxies/NGC5353/DOAO'
	path_gundam	= '/mnt/window/Users/User/Downloads/data/Project/AT2019ein/DOAO'
if obs == 'SOAO':
	path_qso	= '/data3/IMSNG/IMSNGgalaxies/AT2019EIN/SOAO'
	path_gundam	= '/mnt/window/Users/User/Downloads/data/Project/AT2019ein/SOAO'

path_ref	= '/mnt/window/Users/User/Downloads/data/Project/AT2019ein/ref'
#------------------------------------------------------------

...
#	2020.05.18. MADE BY GREGORY S.H. PAEK
#============================================================
import numpy as np
...
#------------------------------------------------------------
path_save	= '/home/sonic/SN2020jfo'
# phot0	= ascii.read(path_save+'/phot4SN2020jfo.dat')
# phot0	= ascii.read('/mnt/window/Users/User/Downloads/data/Project/SN2020jfo/result.dat')
phot0 = ascii.read('/data1/IMSNG/2020jfo/phot.all.dat')
...
t0 = 2458975.70256					#	ZTF DISCOVERY
t0_ut = '2020-05-06T04:51:41.184'
#off		= -0.1
off		= 0.0

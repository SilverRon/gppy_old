...
# tra, tdec = 44.62963541, -8.951577778		#	dim
# tra, tdec = 44.54576833, -8.860788889		#	bright
# tra, tdec = 44.53101417, -8.909809722		#	standard
# aperture = peeing*2
# aperture = '3'							#	DIAMETER
# aperture = str(input('aperture:'))
phottype = 'normal'
tblist = []
for aperture in np.arange(1, 33, 2):

def calc_kcor(filter_name, redshift, colour_name, colour_value):
	...
	Chilingarian, I., Melchior, A.-L., Zolotukhin, I. 2010: Analytical approximations of K-corrections in optical and near-infrared bands, MNRAS, v. 405, p. 1409 (also arXiv:1002.2360)
	[BibTeX entry]   [PDF]
	Chilingarian, I., Zolotukhin, I. 2012: A universal ultraviolet-optical colour-colour-magnitude relation of galaxies, MNRAS, v. 419, p. 1727 (also arXiv:1102.1159)
	[BibTeX entry]   [PDF]

	and include the following sentence in the acknowledgments: This research made use of the ``K-corrections calculator'' service available at http://kcor.sai.msu.ru/
	Contacts
	Please report any bugs and suggestions to chil@sai.msu.ru
	"""
	coeff = {

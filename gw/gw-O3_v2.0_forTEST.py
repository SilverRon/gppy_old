...
#catpath		= '/home/gw/Research/GLADE_2.3.txt'
#catpath		= '/home/gw/Research/GLADE_2.3_within2000.txt'
confidence	= 0.5
#------------------------------------------------------------#
...
os.system('mv bayestar.fits.gz '+save_path+'/'+eventname+'-bayestar.fits.gz')
'''
#	IDL PART (Joonho Kim)
if root.attrib['role'] != 'test':
	os.system('gzip -d bayestar.fits.gz')
	os.system('sh /data3/gwshare/idlpro/gwfollowup_kmtnet.sh')
	os.system('mv bayestar.fits '+save_path+'/'+eventname+'-bayestar.fits')
	os.system('mv '+save_healfix+'sc*.txt '+save_path+'/')
...
#os.system('mv bayestar.fits.gz '+save_healfix+yymmdd+'/'+yymmdd+'-'+hhmmss+'-bayestar.fits.gz')
#os.system('chmod 777 '+save_healfix+yymmdd+'/*')
'''
#------------------------------------------------------------#
...
try:
	...
	cantbl		= Table(	[matchtbl['name'], matchtbl['ra'], matchtbl['dec']],
							names=['name', 'ra', 'dec'])
	cantbl['sort']= 'none'
...
f.write('90% confidence area\t: '+str(skydeg_cut)+'\t[deg^2]\n')
f.write('90% confidence area for Northern\t: '+str(skydeg_cut_N)+'\t[deg^2]\n')
f.write('90% confidence area for Southern\t: '+str(skydeg_cut_S)+'\t[deg^2]\n')

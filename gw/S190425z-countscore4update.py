...
def countscore(objlist, cantbl):
	...
	return score
#------------------------------------------------------------
def findsource(obj, photbl):
	indx = []
	for i, sources in enumerate(photbl['sources']):
		if obj in sources:
			indx.append(i)
	return indx
#------------------------------------------------------------
#	PATH
#------------------------------------------------------------
path_phot = '/data1/S190425z/1.result/Update/phot_upd_sources_GECKO.dat'
path_cand = '/data1/S190425z/info/Update/S190425z_Update-all_candi.txt'
path_save = '/data1/S190425z/1.result/Update'
#------------------------------------------------------------
...
#	SUMMARY
#------------------------------------------------------------
f = open(path_save+'/result4update.dat', 'a')
...
restbl = ascii.read(path_save+'/result4update.dat')
#------------------------------------------------------------
...
photbl.write(path_save+'/phot+score4update.dat', format='ascii', overwrite=True)